          ...
          <div className="inputs space-y-5 pr-8">
            <label htmlFor='firstName' className="input-box pr-2 w-full border rounded flex items-center justify-between">
              <div className="in w-full">
                <FloatingLabel value={firstName} onChange={(e) => setFirstName(e.target.value)} id='firstName' type='text' variant="filled" label="First name" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
              </div>
            ...
            <label htmlFor='fatherName' className="input-box pr-2 w-full border rounded flex items-center justify-between">
              <div className="in w-full">
                <FloatingLabel value={fatherName} onChange={(e) => setFatherName(e.target.value)} id='fatherName' type='text' variant="filled" label="Father name" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
              </div>
              <div className="icon text-teal-500"><FaUser /></div>
            </label>
            <label htmlFor='email' className="input-box pr-2 w-full border rounded flex items-center justify-between">
              <div className="in w-full">
                <FloatingLabel value={email} onChange={(e) => setEmail(e.target.value)} id='email' type='email' variant="filled" label="Email address" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
              </div>
            ...
            <div className="flex gap-5">
              <label htmlFor='password' className="input-box pr-2 w-full border rounded flex items-center justify-between">
                <div className="in w-full">
                  <FloatingLabel value={password} onChange={(e) => setPassword(e.target.value)} id='password' type='password' variant="filled" label="Password" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
                </div>
              ...
              <label htmlFor='confirmPassword' className="input-box pr-2 w-full border rounded flex items-center justify-between">
                <div className="in w-full">
                  <FloatingLabel value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} id='confirmPassword' type='password' variant="filled" label="Confirm Password" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
                </div>
                <div className="icon text-teal-500"><FaLock /></div>
              </label>
            </div>
            <div className='w-full flex gap-5 items-start'>
              <label htmlFor='phoneNo' className="input-box pr-2 w-fit border rounded flex items-center justify-between">
                <div className="in w-full">
                  <FloatingLabel value={phoneNo} onChange={(e) => setPhoneNo(e.target.value)} id='phoneNo' type='tel' variant="filled" label="Phone number" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
                </div>
              ...
              <label htmlFor='DOB' className="input-box pr-2 border rounded flex items-center justify-between">
                <div className="in w-full">
                  <input type="date" value={dob} onChange={(e) => setDOB(e.target.value)} id='DOB' className='focus:ring-0 font-semibold text-teal-500 bg-transparent border-0' />
                </div>
              </label>
              <label htmlFor='sex' className="input-box pr-2 rounded flex items-center justify-between">
                  <select value={sex} onChange={(e) => setSex(e.target.value)} className='rounded focus:ring-0 focus:border-inherit font-semibold text-teal-500 bg-transparent w-fit border border-gray-200'>
                    <option>Sex</option>
