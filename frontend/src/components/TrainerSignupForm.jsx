  ...
  return (
    <>
       <form onSubmit={submitHandler} className="form w-full px-5 my-5">
          ...
          <div className="topc md:my-5 md:space-y-4 space-y-2 my-2 text-gray-600">
        ...
        <div className="inputs space-y-5 pr-8">
          <label htmlFor='firstName' className="input-box pr-2 w-full border rounded flex items-center justify-between">
            <div className="in w-full">
              <FloatingLabel id='firstName' required type='text' value={firstName} onChange={(e) => setFirstName(e.target.value)} variant="filled" label="First name" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
            </div>
          ...
          <label htmlFor='fatherName' className="input-box pr-2 w-full border rounded flex items-center justify-between">
            <div className="in w-full">
              <FloatingLabel id='fatherName' required type='text' value={fatherName} onChange={(e) => setFatherName(e.target.value)} variant="filled" label="Father name" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
            </div>
            <div className="icon text-teal-500"><FaUser /></div>
          </label>
          <label htmlFor='email' className="input-box pr-2 w-full border rounded flex items-center justify-between">
            <div className="in w-full">
              <FloatingLabel id='email' required type='email' value={email} onChange={(e) => setEmail(e.target.value)} variant="filled" label="Email address" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
            </div>
          ...
          <div className="flex gap-5">
            <label htmlFor='password' className="input-box pr-2 w-full border rounded flex items-center justify-between">
              <div className="in w-full">
                <FloatingLabel id='password' minLength={6} type='password' required value={password} onChange={(e) => setPassword(e.target.value)} variant="filled" label="Password" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
              </div>
            ...
            <label htmlFor='confirmPassword' className="input-box pr-2 w-full border rounded flex items-center justify-between">
              <div className="in w-full">
                <FloatingLabel id='confirmPassword' minLength={6} type='password' required value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} variant="filled" label="Confirm Password" className='font-semibold text-teal-500 bg-transparent border-0' sizing="md" />
              </div>
              <div className="icon text-teal-500"><FaLock /></div>
            </label>
          </div>
          <div className='w-full flex gap-5'>
            ...
            <label htmlFor='phoneNo' className="input-box pr-2 border rounded flex items-center justify-between">
              <div className="in w-full">
                <input type="tel" minLength={10} id='phoneNo' required value={phoneNo} onChange={(e) => setPhoneNo(e.target.value)} placeholder='Phone number' className='placeholder:text-inherit focus:ring-0 font-semibold text-teal-500 bg-transparent border-0' />
              </div>
            </label>
          </div>
