...
const TrainerChatComponent = () => {
  // const [isSelected, setIsSelected] = useState(false);

  return (
    <>
    <div className='flex items-center justify-center w-full h-full sm:text-3xl text-teal-500'>
      <div>
        <p className='text-center'>This section is under construction.</p>
...
export default TrainerChatComponent