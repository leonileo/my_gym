...
const TrainerDashboard = () => {
  ...
  const progress = [
    {
      ...
      progress: [
        ...
        note: "Today's workouts is a really great workout"
      },
        {
        workout: 'Pushup',
        clientPicture: gymImg,
  ...
  return (
    <div className='w-full min-h-[100vh] h-full flex items-start bg-gray-100 '>
      ...
      {/* right */}
      <div className="right overflow-auto overflow-x-hidden w-full h-[100vh] xl:flex-row flex-col-reverse flex">
        <div className="rmiddle p-5 xl:w-[75%] w-full">
          ...
          <div className="client-request">
            ...
            <div className={`${requests ?"bg-gray-200" : "bg-white"} w-full rounded min my-5 p-2`}>
              {requests ? (<>
                {/* for desktop */}
                  ...
                  {clients.map((client, x) => (
                    <tr className='w-full'>
                        ...
                        <td className='p-5 md:block hidden'>
                          <div
                          style={{
                            backgroundImage: `url(${client.picture})`,
                            backgroundRepeat: "no-repeat",
                            backgroundSize: "cover",
                            backgroundPosition: "center",
                          }}
                        ...
                        <td className='md:text-start text-center'>{client.name}</td>
        ...
        <div className="rright md:mb-0 mb-10 xl:w-[25%] w-full h-full md:border-l-4">
          <div className="client-info h-full">
            <h2 className='pt-2 px-5 text-2xl my-5 text-gray-600 border-red-500 rounded'>Client's progress info</h2>
            <div className="top h-[90%] px-5">
            {progress ? 
              <>
              <Swiper
                    slidesPerView={1}
                    ...
                    {progress.map(progress => (
                      <SwiperSlide className='h-full bg-white px-5 p-2 rounded'>
                        <div className='pl-3 h-full'>
                          <p className='text-center text-gray-500 font-semibold text-xl'>Progress data of {progress.clientId}</p>
                          {/* weight pictures */}
                          ...
                          <div className="notes my-5">
                            ...
                            <div className="note border rounded bg-gray-50 p-2 my-5 max-h-[10vh] overflow-auto">
                              <p className=''>{progress.progress[0].note ? progress.progress[0].note : 'None enjoy the silence.' }</p>
                            </div>
                          </div>

                          {/* progress report */}
                          <div className="progress-report my-5">
                            <p className='text-gray-500 font-semibold text-xl flex gap-3 items-center'>Progress reports <TbReportAnalytics/> </p>
                            <div className='my-5'>
